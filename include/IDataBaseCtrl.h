...
struct IDataBaseCtrl
{
    ...
    virtual DataBaseResponce add(enu_tables eTable, const std::map<std::string, std::string>& mArgs) = 0;

    virtual DataBaseResponce edit(enu_tables eTable, const std::map<std::string, std::string>& mArgs) = 0;
};
